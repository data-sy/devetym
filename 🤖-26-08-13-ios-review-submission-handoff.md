...
- **웹 브랜치 `docs/web-track-autonomy-prep`가 로컬 전용·미푸시** — 거기에 **제보 원문 아카이브**(`docs/feedback/26-08-08-외부-제보.md`, `cdcfe52`)가 들어 있어, 병합 전까지 원문이 main에 없다. 병합 시점은 웹 트랙 감사(0/26 판정 대기)와 묶인 별개 판단.
