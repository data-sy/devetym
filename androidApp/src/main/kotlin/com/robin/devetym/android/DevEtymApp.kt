...
import com.robin.devetym.BuildConfig
 ...
 *
 * M9 WU-4 — 크래시 DSN(`BuildConfig.SENTRY_DSN`)을 initKoin에 주입(비면 no-op).
 */
class DevEtymApp : Application() {
    override fun onCreate() {
        super.onCreate()
        runBlocking { initKoin(androidPlatformModule(this@DevEtymApp), crashDsn = BuildConfig.SENTRY_DSN) }
    }
}
