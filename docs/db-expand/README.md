...
- 라운드별 산출물·세션 기록(`rounds/`·`archive/`)은 **2026-08-25 서류 정돈에서 삭제**했다 — 종결된 작업의 실행 기록이라 git 이력으로 충분하다(`git show 0d4c57e:docs/db-expand/rounds/round-004.md`). 결과 요약은 위 「상태」.
