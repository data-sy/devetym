...
> - `[AI→사람]` 지그 5종 = [`docs/release/`](../../release/README.md). iOS 시뮬 첫 기동·메인 앱·양 테마·반응형 DB 실증(§4 게이트 티어화).
> - **다음 작업 핸드오프**: [Android 에뮬 스모크](m9-android-emulator-smoke-handoff.md)(다음 세션) · [티어형 스모크 대본](../../release/README.md)(Tier 1 iOS 진행 중, Tier 2·3 잔여).
