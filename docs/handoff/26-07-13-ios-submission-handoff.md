...
| 스크린샷 | raw `~/devetym-shots/ios/` · **프레임드 5컷 × 2사이즈(D2 개정 2026-07-14)**: 6.9" = `framed-6.9/`(1320×2868) · 6.5" = `framed-6.5/`(1242×2688). 순서 확정: f1 후크(bug)→f2 AI→f3 북마크→f4 검색→f5 라이트(캡션·근거 = [캡처 핸드오프 §1b](../release/m9-screenshot-capture-handoff.md)). 구 `framed/` 6컷은 superseded | D1(D2 개정). 잔여 = 콘솔 슬롯별 업로드 |
| 지역 | **한국 단독** | D2 |
